...
const initialFormData: OrderFormValues = {
  status: "pendiente",
  orderType: "",
  paymentMethod: "",
  clientId: "",
...
export function AddOrderDialog({
  ...
  const [formData, setFormData] = useState<OrderFormValues>(initialFormData);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    onAddOrder({ ...formData, details: formData.details.trim() });
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Crea el encabezado del pedido con persistencia optimista inmediata.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData((prev) => ({
                    ...prev,
                    status: (value ?? prev.status) as OrderFormValues["status"],
                  }))
                }
              >
                <SelectTrigger
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              El total del pedido se calcula desde los productos relacionados en el servidor.
            </p>
          </div>
